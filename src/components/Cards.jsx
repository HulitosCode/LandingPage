        ...
        <div className='w-full bg-white py-[10rem] px-4 '>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 p-4'>
                <div className='w-full shadow-2xl border-2 border-blue-600 flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    ...
                    <button className='bg-blue-600 text-white w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Contactar</button>
                </div>
                <div className='w-full shadow-2xl border-2 border-purple-600 flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300'>
                    ...
                    <p className='py-2 border-b mx-8 mt-8'>Site Responsivo</p>
                        ...
                        <p className='py-2 border-b mx-8'>Manutenção e Atualizações por 1 Ano</p>
                        <p className='py-2 border-b mx-8'>1 Ano de Dominio Gratuito</p>
                        <p className='py-2 border-b mx-8'>1 Ano de Hospedagem Gratuita</p>
                    </div>
                    <button className='bg-purple-600 text-white w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3'>Contactar</button>
                </div>
                <div className='w-full border-2 border-pink-600 shadow-2xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    ...
                    <button className='bg-pink-600 w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-white'>Contactar</button>
                </div>
            </div>
        </div>
    );
