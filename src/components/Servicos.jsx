    ...
    return (
        <div id="servicos" className="py-16 text-white px-4 text-center">
            <div className="max-w-screen-xl mx-auto">
                <div data-aos="zoom-in" className="lg:col-span-2">
                ...
                <button data-aos="fade-up" className="hover:scale-105 duration-300 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-white">
