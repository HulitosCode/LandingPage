            ...
            <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 p-4">
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <p className="text-gray-400">
                        Entendemos que investir em desenvolvimento web e identidade visual é um passo importante. Por isso, oferecemos preços competitivos e pacotes escaláveis para atender a empresas de todos os tamanhos.                    </p>
                    <button className="hover:scale-105 duration-300 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3 text-white">Get Started</button>
                </div>
            </div>
        </div>
    );
