    ...
    return (
        <div id="sobre" className="w-full bg-black py-16 px-4 lg:mt-[-5px]">
            <div className="grid md:grid-cols-2 text-white max-w-screen-xl gap-8 mx-auto p-4">
                <img data-aos="fade-right" className="h-full w-full object-cover" src={Sobre} alt="/" />
            ...
            <div className="grid md:grid-cols-2 text-white max-w-screen-xl gap-8 mx-auto py-10 p-4">
                <div className="py-10">
                    <div data-aos="fade-down" className="bg-[#0c0c0c] black border-l-8 border-purple-900 rounded-lg p-8 hover:scale-105 duration-300">
                    ...
                    <br />
                    <div data-aos="fade-up" className="bg-[#0c0c0c] py-10 border-r-8 border-purple-900 rounded-lg p-8 hover:scale-105 duration-300">
                ...
                <div data-aos="zoom-out" className="py-10">
